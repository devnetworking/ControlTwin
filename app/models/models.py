...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(Enum(UserRole, name="user_role"), nullable=False, default=UserRole.READONLY)
...
class Site(Base):
    ...
    sector: Mapped[Sector] = mapped_column(Enum(Sector, name="sector"), nullable=False, default=Sector.GENERIC)
...
class Asset(Base):
    ...
    criticality: Mapped[Criticality] = mapped_column(Enum(Criticality, name="criticality"), nullable=False, default=Criticality.MEDIUM)
    status: Mapped[AssetStatus] = mapped_column(Enum(AssetStatus, name="asset_status"), nullable=False, default=AssetStatus.UNKNOWN)
...
class DataPoint(Base):
    ...
    name: Mapped[str] = mapped_column(String(128), nullable=False)
    tag: Mapped[str] = mapped_column(String(128), nullable=False)
    data_type: Mapped[DataType] = mapped_column(Enum(DataType, name="data_type"), nullable=False)
...
class Collector(Base):
    ...
    site_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("sites.id"), nullable=False)
    name: Mapped[str] = mapped_column(String(128), nullable=False)
    protocol: Mapped[CollectorProtocol] = mapped_column(Enum(CollectorProtocol, name="collector_protocol"), nullable=False)
    host: Mapped[str] = mapped_column(String(255), nullable=False)
    port: Mapped[int] = mapped_column(Integer, nullable=False)
    config: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    poll_interval_ms: Mapped[int] = mapped_column(Integer, default=1000, nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    status: Mapped[CollectorStatus] = mapped_column(Enum(CollectorStatus, name="collector_status"), default=CollectorStatus.STOPPED, nullable=False)
